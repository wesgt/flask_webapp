...
class IAPTestCase(unittest.TestCase):
    ...
    def test_iap_receipts_verify_return_correct(self):
        ...
        verify_result = str(verify_rv.data[0:4], 'utf-8')
        self.assertEqual(ResultType.VERIFY_SUCCESS, verify_result)

    def test_iap_receipts_verify_restore(self):
        receipt_data = ''
        verify_rv = self.client.post(
            '/mobile/iap/receipts/verify',
            data=dict(udid='1234', receipt_data=receipt_data),
    ...
    def test_iap_receipts_verify_return_error(self):
        verify_rv = self.client.post(
            '/mobile/iap/receipts/verify',
            data=dict(udid='1234', receipt_data=''),
            follow_redirects=False)

        verify_result = str(verify_rv.data[0:4], 'utf-8')
        self.assertEqual(ResultType.VERIFY_FAIL, verify_result)

    def test_iap_token_verify_return_correct(self):
