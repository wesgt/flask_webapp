...
class IAPTestCase(unittest.TestCase):
    ...
    def setUpClass():
        ...
        webapp.app.register_blueprint(iap, url_prefix='/iap')
        pass
    ...
    def test_iap_receipts_verify_return_correct(self):
        ...
        verify_rv = self.app.post(
            '/iap/receipts/verify', data=dict(receipt_data=receipt_data),
    ...
    def test_iap_receipts_verify_return_error(self):
        verify_rv = self.app.post(
            '/iap/receipts/verify', data=dict(receipt_data=''),
            follow_redirects=False)
